...
public class AlignToLeftCoral extends Command {
  AdjustToCoral m_adjustToCoral;

  /** Creates a new AlignToLeftCoral. */
  public AlignToLeftCoral() {
    super(Drive.getInstance(), "Auto Commands", "AlignToLeftCoral");
  ...
  private TargetPose coralPoseSupplier() {
    return new TargetPose(FieldUtils.getInstance().getCoralStationPose(CoralStationSide.kLeft, CoralStationOffset.kLeft),
      false);
  }
