...
public class SwerveDrive extends Command {
  ...
  public void execute() {
    ...
    m_drive.drive(
      -MathUtil.applyDeadband(m_DriveInputs.getX(), Constants.OIConstants.kDriveDeadband),
      -MathUtil.applyDeadband(m_DriveInputs.getY(), Constants.OIConstants.kDriveDeadband),
      rotationPower,
      true, false);
  }
